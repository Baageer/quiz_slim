...
def parse_args(check=True):
    ...
    parser.add_argument('--model_name', type=str, default='densenet_w7_2')
    ...
    parser.add_argument('--max_num_batches', type=str, default='128')

    FLAGS, unparsed = parser.parse_known_args()
    return FLAGS, unparsed


train_cmd = 'python3 ./train_image_classifier.py  --dataset_name={dataset_name} --dataset_dir={dataset_dir} --checkpoint_path={checkpoint_path} --model_name={model_name}  --train_dir={train_dir} --learning_rate={learning_rate} --optimizer={optimizer} --batch_size={batch_size} --max_number_of_steps={max_number_of_steps}'
